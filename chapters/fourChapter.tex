...
在线渲染阶段： 提出感知引导的自适应细分LOD算法，利用 GPU 硬件镶嵌单元，依据castleCSF-TS 模型计算的降采样因子，在基础 LOD 上进行像素级精度的表面重构，实现了动画网格在时空维度上的平滑细节过渡和高效资源分配。
...
\Function{\textbf{STMF-SIMPLIFICATION}}{$M$, $R$}
